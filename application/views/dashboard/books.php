        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo anchor('book/view/'.$book_item['idbuku'], 'View'); ?> | <?php echo anchor('book/edit/'.$book_item['idbuku'], 'Edit') ?> | <?php echo anchor('book/delete/'.$book_item['idbuku'], 'Del'); ?></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
          <tfoot>
